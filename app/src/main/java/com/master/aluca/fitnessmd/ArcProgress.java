...
public class ArcProgress extends View {
    ...
    private float progress_weight = 0.0f;
    ...
    private final String default_date_text;
    private String dateText = "2 November 2016";
    ...
    private static final String INSTANCE_PROGRESS_WEIGHT = "progress_weight";
    private static final String INSTANCE_IS_WEIGHT = "is_weight";
    private static final String INSTANCE_MAX = "max";
    private static final String INSTANCE_FINISHED_STROKE_COLOR = "finished_stroke_color";
    private static final String INSTANCE_UNFINISHED_STROKE_COLOR = "unfinished_stroke_color";
    private static final String INSTANCE_ARC_ANGLE = "arc_angle";
    private static final String INSTANCE_SUFFIX = "suffix";
    private static final String INSTANCE_DATE_TEXT = "date_text";
    ...
    public ArcProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        default_date_text = "2 November, 2016";
    ...
    protected void initByAttributes(TypedArray attributes) {
        ...
        dateText = TextUtils.isEmpty(attributes.getString(R.styleable.ArcProgress_arc_date_text)) ? default_date_text : attributes.getString(R.styleable.ArcProgress_arc_date_text);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (!TextUtils.isEmpty(text)) {
            ...
            canvas.drawText(suffixText, getWidth() / 2 - 25, textBaseline - suffixHeight * 2.0f, textPaint);
    ...
    protected Parcelable onSaveInstanceState() {
        ...
        bundle.putFloat(INSTANCE_PROGRESS_WEIGHT, getProgressWeight());
        bundle.putBoolean(INSTANCE_IS_WEIGHT, getIsWeight());
        bundle.putInt(INSTANCE_MAX, getMax());
        bundle.putInt(INSTANCE_FINISHED_STROKE_COLOR, getFinishedStrokeColor());
        bundle.putInt(INSTANCE_UNFINISHED_STROKE_COLOR, getUnfinishedStrokeColor());
        bundle.putFloat(INSTANCE_ARC_ANGLE, getArcAngle());
        bundle.putString(INSTANCE_SUFFIX, getSuffixText());
        bundle.putString(INSTANCE_DATE_TEXT, getDateText());
        return bundle;
    }
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        if(state instanceof Bundle) {
            ...
            dateText = bundle.getString(INSTANCE_DATE_TEXT);
            initPainters();
