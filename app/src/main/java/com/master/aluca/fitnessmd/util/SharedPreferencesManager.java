package com.master.aluca.fitnessmd.util;
...
public class SharedPreferencesManager {
    ...
    public String getUserHasSubscription() {
        return mSubscription;
    }

    public void setUserHasSubscription(String subscription) {
        sharedPreferencesEditor.putString(Constants.SHARED_PREFS_SUBSC_KEY, subscription);
        sharedPreferencesEditor.commit();
